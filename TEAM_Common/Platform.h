...
#define PL_CONFIG_HAS_SUMO				(1 && !defined(PL_LOCAL_CONFIG_HAS_SUMO_DISABLED) && PL_LOCAL_CONFIG_BOARD_IS_ROBO)
#define PL_HAS_DISTANCE_SENSOR          (0 && !defined(PL_LOCAL_CONFIG_HAS_DISTANCE_DISABLED) && PL_CONFIG_BOARD_IS_ROBO)
#define PL_HAS_TOF_SENSOR               (0 && !defined(PL_LOCAL_CONFIG_HAS_TOF_SENSOR_DISABLED) && PL_HAS_DISTANCE_SENSOR)
